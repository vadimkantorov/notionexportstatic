...
def sitepages2html(page_ids = [], ctx = {}, notion_pages = {}, block2html = (lambda page, ctx: '')):
    ...
    style = notion_css + notion_colors_css + twitter_emoji_font_css + minima_css
...
.notion-table_of_contents-heading > a {
    color: rgb(120, 119, 116) !important;
}
.notion-table_of_contents-heading:hover {
